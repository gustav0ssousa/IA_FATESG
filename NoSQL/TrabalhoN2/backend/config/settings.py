...
env = environ.Env(
    ...
    EMBEDDING_SERVICE_MAX_RETRIES=(int, 1),
    EMBEDDING_SERVICE_RETRY_BASE_DELAY_SECONDS=(float, 1.0),
...
EMBEDDING_SERVICE_BATCH_SIZE = env("EMBEDDING_SERVICE_BATCH_SIZE")
EMBEDDING_SERVICE_MAX_RETRIES = env("EMBEDDING_SERVICE_MAX_RETRIES")
EMBEDDING_SERVICE_RETRY_BASE_DELAY_SECONDS = env(
    "EMBEDDING_SERVICE_RETRY_BASE_DELAY_SECONDS"
)
